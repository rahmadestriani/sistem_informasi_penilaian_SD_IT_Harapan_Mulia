          ...
          <div class="card-body">
                    <table class="table card-text">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT * FROM nilai1 where id_mapel='M004'";
                        ...
                        <tr>
                          <td>
                            <a href="nilai_4_ubah.php?id_nilai=<?php echo $nilai['id_nilai'];?>">
                  ...
                  <div>
                    <center>
                    <a href="nilai_4_form.php" class="btn btn-lg btn-success">TAMBAH</a>
                    </center>
                  </div>
            </div>
          </div>
