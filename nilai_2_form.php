...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="nilai_2_tampil.php" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Form Data Nilai</b>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container">
          <form role="form" action="nilai_2_simpan.php" method="POST">
          <center>
          ...
          <div class="input-group-prepend">
            ...
            <input disabled="" type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_mapel" value="<?php echo 'M002'; ?>">
          </div>
