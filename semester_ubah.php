<?php
  ...
  $id_semester = $_GET ['id_semester'];
    ...
    $semester=mysqli_fetch_array($hasil);
    $nama_semester=$semester['nama_semester'];
    $jenis_semester=$semester['jenis_semester'];
?>
  ...
  <body>
    ...
    <header class="header">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container">
          <form role="form" action="semester_update.php" method="POST">
          <center>
          ...
          <div class="input-group-prepend">
            ...
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_semester" value="<?php echo $id_semester; ?>">
          </div>
          ...
          <div class="input-group-prepend">
            ...
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="nama_semester" value="<?php echo $nama_semester; ?>">
          </div>
          ...
          <div class="input-group-prepend">
            ...
            <select name="jenis_semester" class="form-control">
              <option <?php if (strtolower($jenis_semester) == 'ganjil') {?> selected="true" <?php } ?>>Ganjil</option>
              <option <?php if (strtolower($jenis_semester) == 'genap') {?> selected="true" <?php } ?>>Genap</option>
            </select>
          </div>
