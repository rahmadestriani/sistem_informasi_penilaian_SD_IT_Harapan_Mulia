  ...
  <body>
    ...
    <header class="header">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container">
          <form role="form" action="mapel_simpan.php" method="POST">
          <center>
          ...
          <div class="input-group-prepend">
            ...
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_mapel">
          </div>
          ...
          <div class="input-group-prepend">
            ...
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="nama_mapel">
          </div>
