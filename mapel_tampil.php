...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="tu.html" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Data Mapel</b>
          ...
          <div class="card-body">
                    <table class="table card-text">
                      ...
                      <tbody>
                        ...
                        while ($mapel=mysqli_fetch_array($hasil))
                        {
                        ?>
                        <tr>
                          <td>
                            <a href="mapel_ubah.php?id_mapel=<?php echo $mapel['id_mapel'];?>">
                  ...
                  <div>
                    <center>
                    <a href="mapel_form.php" class="btn btn-lg btn-success">TAMBAH</a>
                    </center>
                  </div>
            </div>
          </div>
