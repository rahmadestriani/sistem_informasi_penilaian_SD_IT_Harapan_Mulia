...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="menu_guru.html" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Data Nilai</b>
          ...
          <div class="card-body">
                    <table class="table card-text">
                      ...
                      <tbody>
                        ...
                        $query = "SELECT * FROM nilai1 where id_mapel='M001'";
                        ...
                        <tr>
                          <td>
                            <a href="nilai_1_ubah.php?id_nilai=<?php echo $nilai['id_nilai'];?>">
                              <?php echo $nilai['id_nilai']; ?>
                            </a>
                          </td>
                          <td>
                            <?php echo $nilai['NIS']; ?>
                  ...
                  <div>
                    <center>
                    <a href="nilai_1_form.php" class="btn btn-lg btn-success">TAMBAH</a>
                    </center>
                  </div>
            </div>
          </div>
