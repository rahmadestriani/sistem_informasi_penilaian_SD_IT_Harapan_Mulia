...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="tu.html" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Data Kelas</b>
          ...
          <div class="card-body">
                    <table class="table card-text">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <a href="kelas_ubah.php?id_kelas=<?php echo $kelas['id_kelas'];?>">
                  ...
                  <div>
                    <center>
                    <a href="kelas_form.php" class="btn btn-lg btn-success">TAMBAH</a>
                    </center>
                  </div>
            </div>
          </div>
