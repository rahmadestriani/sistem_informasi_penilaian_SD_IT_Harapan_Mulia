  ...
  <body>
    ...
    <header class="header">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container">
          <center>
            <form role="form" action="cetak_proses.php" method="POST">
          <div class="col-lg-6 mb-5">
          
          <br><br>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <button id="button-addon1" type="button" class="btn btn-pilihan text-primary">ID RAPOR</button>
          </div>
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_rapor">
          </div>
          ...
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <button id="button-addon1" type="button" class="btn btn-pilihan text-primary">TAHUN PELAJARAN</button>
          </div>
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="tahun_pelajaran">
          </div>
          ...
          <div>
            <button type="submit" class="btn btn-lg btn-success">LIHAT</button>
          </div>
