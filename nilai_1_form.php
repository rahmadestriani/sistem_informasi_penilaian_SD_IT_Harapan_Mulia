...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="nilai_1_tampil.php" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Form Data Nilai</b>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container">
          <form role="form" action="nilai_1_simpan.php" method="POST">
          <center>
          ...
          <div class="input-group-prepend">
            ...
            <input type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_nilai">
          </div>
          ...
          <div class="input-group-prepend">
            ...
            <input disabled="" type="text" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" class="form-control" name="id_mapel" value="<?php echo 'M001'; ?>">
          </div>
          ...
          <div class="input-group-prepend">
            <button id="button-addon1" type="button" class="btn btn-pilihan text-primary">UH</button>
              ...
              <input type="text" placeholder="UH 1" class="form-control" name="uh1">
              
              
              <input type="text" placeholder="UH 2" class="form-control" name="uh2">
             
              
              <input type="text" placeholder="UH 3" class="form-control" name="uh3">
              
              
              <input type="text" placeholder="UH 4" class="form-control" name="uh4">
          ...
          <div class="input-group-prepend">
            ...
            <div class="row">
              <div class="col-md-3">
              <input type="text" placeholder="" class="form-control" name="uts">
              </div>
            </div>
          </div>
          ...
          <div class="input-group-prepend">
            ...
            <div class="row">
              <div class="col-md-3">
              <input type="text" placeholder="" class="form-control" name="uas">
              </div>
            </div>
          </div>
