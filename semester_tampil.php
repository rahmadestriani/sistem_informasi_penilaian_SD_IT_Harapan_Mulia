...
<html>
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar px-4 py-2 bg-tua shadow"><a href="tu.html" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="o-exit-1 fa-align-center"></i></a><b class="navbar-brand font-weight-bold text-uppercase text-center ">Data Semester</b>
          ...
          <div class="card-body">
                    <table class="table card-text">
                      ...
                      <tbody>
                        ...
                        while ($semester=mysqli_fetch_array($hasil))
                        {
                        ?>
                        <tr>
                          <td>
                            <a href="semester_ubah.php?id_semester=<?php echo $semester['id_semester'];?>">
                              <?php echo $semester['id_semester']; ?>
                            </a>
                          </td>
                          <td>
                          ...
                          <td>
                            <?php echo $semester['jenis_semester']; ?>
                          </td>
                          </tr>
                        <?php
                        }
                  ...
                  <div>
                    <center>
                    <a href="semester_form.php" class="btn btn-lg btn-success">TAMBAH</a>
                    </center>
                  </div>
            </div>
          </div>
